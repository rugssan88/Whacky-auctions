...
has(app, 'Register to become a verified bidder', 'Private bidder-registration link missing from the account page.');
has(sw, "whacky-v6-first-100-funnel", 'Service-worker cache version was not bumped for the first-100 signup release.');
