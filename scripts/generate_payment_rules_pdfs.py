...
doc2=SimpleDocTemplate(OUT+'standard-live-auction-rules-2026.pdf',pagesize=letter,rightMargin=18*mm,leftMargin=18*mm,topMargin=18*mm,bottomMargin=20*mm,title='Whacky Auctions Standard Live Auction Rules 2026 v1.2',author='Whacky Auctions PTY LTD')
